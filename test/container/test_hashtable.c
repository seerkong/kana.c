...
TEST Table_PushVal_IndexGet(void) {
    ...
    for (int i = 0; i < 5; i++) {
        KxHashTable_PushVal(table, (ktable_val_t)i);
    }
...
TEST Table_PutKv_IndexGet(void) {
    ...
    KxHashTable_PutKv(table, "abc", (ktable_val_t)value1);
    KxHashTable_PutKv(table, "bcd", (ktable_val_t)value2);
...
TEST Table_PushKv_IndexGet(void) {
    ...
    KxHashTable_PushKv(table, "abc", (ktable_val_t)value1);
    KxHashTable_PushKv(table, "bcd", (ktable_val_t)value2);
    KxHashTable_PushKv(table, "abc", (ktable_val_t)value3);
