...
//         KN test_kon_string = KON_MakeString(&kstate, "hi!");

//         KN hi_ptr = KON_MakeString(&kstate, "hi!");
...
//     if (hash_map) {
//         // make string
//         KN test_kon_string = KON_MakeString(&kstate, "asdfff");

//         // make list
//         KN list1 = kon_list1(&kstate, test_kon_string);
...
//         // 获取值
//         KN value = (KN)tb_hash_map_get(hash_map, "key");
//         KN list1_car = kon_car(value);
